...
{
    public class CompanyAddressModelMapping : IEntityTypeConfiguration<CompanyAddressModel>
    {
        public void Configure(EntityTypeBuilder<CompanyAddressModel> builder)
        {
            ...
            builder.ToTable("Company_Address");
        }
    }
}
